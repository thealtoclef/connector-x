...
#[derive(Error, Debug)]
pub enum SpannerArrowTransportError {
    #[error(transparent)]
...
pub struct SpannerArrowTransport;

impl_transport!(
    name = SpannerArrowTransport,
    error = SpannerArrowTransportError,
...
impl TypeConversion<DateTime<Utc>, DateTimeWrapperMicro> for SpannerArrowTransport {
